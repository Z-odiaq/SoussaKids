...
public class WordSearch : MonoBehaviour
{
    ...
    public GameObject tile, background, current, WinScreen;
    ...
    public static Dictionary<string, bool> insertedWords = new Dictionary<string, bool>();
    ...
    {
        backgroundObject.transform.position = Camera.main.ScreenToWorldPoint(new Vector3((Screen.width / 2) - 4, (Screen.height / 2) + -50, 10));
    }
    ...
    void Update()
    {
        ...
        if (insertedWords.Count == 0)
        {
            ...
            this.gameObject.GetComponent<MonoBehaviour>().enabled = false;
        }
    ...
    //     GUILayout.Label("   Temps: ", style);
    //     GUILayout.Label(TimeElapsed(), style);
    //     GUILayout.EndHorizontal();
    //     GUILayout.Label("   Chercher Ces Mots: ", style);
    ...
    //         GUILayout.Label("      " + p.Key.ToUpper(), style);

    //         // GUI.Label(new Rect(10, 10, 100, 20), p.Key);
